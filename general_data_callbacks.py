...
def register_general_data_callbacks(app):
    @app.callback(
        Output('general-data-content', 'children'),
        Output('visitas-chart', 'figure'),
        Output('my_dept_map', 'figure'), 
        Output('stack_bar_chart', 'figure'),
        Input('some-input', 'value'),
        Input('fecha_slider', 'value'),
        Input('slct_mode', 'value'), 
        Input('select_year', 'value')
        )

    def update_general_data_content(some_value, year_range, selected_year, option_slctd):
    ...
    #Grafico de barras consumo de energia por año 
    ...
    #Mapa de ubicacion de pozos activos e inactivos 
        ...
        return some_value, fig, fig_bar, fig_map